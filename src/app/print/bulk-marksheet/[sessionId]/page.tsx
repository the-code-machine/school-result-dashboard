...
export default function BulkMarksheetPrintPage() {
  ...
  // Filter only students with computed results, and assign ranks
    ...
    <div className="min-h-screen bg-gray-200 p-4 md:p-8" style={tv}>
      ...
      <div className="max-w-[210mm] mx-auto mb-4 flex justify-between items-center no-print bg-white p-3 rounded-xl shadow-sm border border-gray-200">
        ...
        <Button
          ...
          className="gap-2 shadow-md bg-violet-600 hover:bg-violet-700"
        >
          <Printer className="w-4 h-4" /> Print {students.length} Marksheets
        </Button>
      </div>
      ...
      {students.map((student, idx) => {
        ...
        if (classCfg.bestOfCount < classCfg.totalSubjects) {
          ...
          if (passed.length > classCfg.bestOfCount) {
            droppedSubjectSlot = [...passed].sort(
              (a, b) => a.total - b.total,
            )[0].slot;
              ...
              >
                ...
                >
                  {[
                    ...
                    [
                      "पिता का नाम श्री FATHER'S NAME SHRI –",
                      student.fatherName,
                    ],
                    [
                    ...
                    <React.Fragment key={label}>
                      <div
                        style={{ whiteSpace: "nowrap", color: "var(--theme)" }}
                      >
                        {label}
                      </div>
                      <div
                  ...
                  <tbody>
                    {computed.subjectTotals.map((sub) => {
                      ...
                      return (
                        <tr
                          key={sub.slot}
                          style={{ borderBottom: TB, height: 22 }}
                        >
                          <td
                            style={{
                              border: TB,
                          ...
                          <td style={{ border: TB, padding: "1px" }}>
                            {qWeight}
                          </td>
                          <td style={{ border: TB, padding: "1px" }}>
                            {hyWeight}
                    ...
                    <tr
                      className="th-lbg"
                      style={{ borderBottom: TB2, height: 22 }}
                    >
                      <td
                        style={{
                          border: TB,
                      ...
                      <td style={{ border: TB }} />
                      <td
                        style={{ border: TB, padding: "1px", fontSize: "7pt" }}
                      >
                        {computed.subjectTotals.reduce(
                          (sum, s) => sum + s.total,
                          0,
                ...
                >
                  ...
                  <tbody>
                    <tr style={{ fontSize: "9pt" }}>
                      ...
                      <td
                        style={{ border: TB, padding: "3px", color: "#c0392b" }}
                      >
                        {computed.maxMarks}
                      </td>
                      <td style={{ border: TB, padding: "3px" }}>
                ...
                >
                  # से दर्शाया गया विषय कुल योग में शामिल नहीं है। परीक्षा
                  परिणाम बेस्ट फाइव पद्धति के आधार पर तैयार किया गया है।
                  <br />
                  Shown subject is not included in the grand total. The result
                  of the exam has been prepared on the basis of best five
                  method.
                </div>
              ...
              >
                ...
                >
                  <li style={{ marginBottom: 3 }}>
                    सभी विषयों की सैद्धांतिक व प्रायोगिक / आंतरिक परीक्षा में
                    उत्तीर्ण होने के लिए अलग–अलग न्यूनतम 33% अंक प्राप्त करना
                    अनिवार्य है।
                  </li>
                  <li style={{ marginBottom: 3 }}>
                    सभी विषयों के अधिकतम अंकों के योग में 60% अथवा अधिक
                    प्राप्तांक होने पर प्रथम श्रेणी, 45% अथवा अधिक किंतु 60% से
                    कम प्राप्तांक होने पर द्वितीय श्रेणी तथा 33% अथवा अधिक किंतु
                    45% से कम प्राप्तांक होने पर तृतीय श्रेणी प्रदान की जाती है।
                  </li>
                  <li style={{ marginBottom: 3 }}>
                    संगीत (गायन वादन / तबला पखावज) विषय में सैद्धांतिक व
                    प्रायोगिक परीक्षा के अधिकतम अंक 25-75 एवं व्यावसायिक विषयों
                    में सैद्धांतिक व प्रायोगिक परीक्षा के अधिकतम अंक 40-60
                    निर्धारित हैं। उत्तीर्ण होने के लिए दोनों भागों में न्यूनतम
                    33% अंक प्राप्त करना अनिवार्य है।
                  </li>
                  <li style={{ marginBottom: 3 }}>
                    विषय में सैद्धांतिक / प्रायोगिक / आंतरिक भाग में 33% से कम
                    प्राप्तांक होने की दशा में पात्रतानुसार पूरक परीक्षा देनी
                    होगी। उन्हें केवल उसी भाग में पूरक परीक्षा देनी होगी जिसमें
                    प्राप्तांक 33% से कम हैं।
                  </li>
                  <li style={{ marginBottom: 3 }}>
                  ...
                  <li>
                    ...
                    प्राप्तांकों के आधार पर निम्नानुसार ग्रेड निर्धारित किये गये
                    हैं–
                  </li>
                </ol>
